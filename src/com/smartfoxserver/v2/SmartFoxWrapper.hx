...
class SmartFoxWrapper // extends SmartFox
{
	...
	function get_useWebSocket():Bool {
		return sfsExt.useWebSocket;
	}

	function set_useWebSocket(value:Bool):Bool {
		return sfsExt.useWebSocket = value;
	}

	public var useBlueBox(get, set):Bool;

	function get_useBlueBox():Bool {
		return sfsExt.useBlueBox;
	}

	function set_useBlueBox(value:Bool):Bool {
		return sfsExt.useBlueBox = value;
	}
