...
class SFSEvent extends BaseEvent {
	...
	@:isVar public var cmd (get, set):String;
	@:isVar public var popupMsg:String;
	@:isVar public var errorCode (get, set):Int;
	@:isVar public var errorMessage (get, set):String;
	@:isVar public var success (get, set):Dynamic;
	@:isVar public var room (get, set):Dynamic;
	@:isVar public var message (get, set):String;
	@:isVar public var user (get, set):Dynamic;
