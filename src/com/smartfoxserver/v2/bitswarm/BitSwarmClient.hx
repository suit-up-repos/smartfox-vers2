...
class BitSwarmClient extends EventDispatcher 
{
	...
	*/
	...
	public function destroy():Void
	{
		...
		_bbClient.removeEventListener(BBEvent.CONNECT, onBBConnect);
		_bbClient.removeEventListener(BBEvent.DATA, onBBData);
		_bbClient.removeEventListener(BBEvent.DISCONNECT, onBBDisconnect);
		_bbClient.removeEventListener(BBEvent.IO_ERROR, onBBError);
		_bbClient.removeEventListener(BBEvent.SECURITY_ERROR, onBBError);

		_wsClient.removeEventListener(WSEvent.CONNECT, this.onWSConnect);
		_wsClient.removeEventListener(WSEvent.DATA, this.onWSData);
		_wsClient.removeEventListener(WSEvent.CLOSED, this.onWSClosed);
		_wsClient.removeEventListener(WSEvent.IO_ERROR, this.onWSError);
		_wsClient.removeEventListener(WSEvent.SECURITY_ERROR, this.onWSSecurityError);
